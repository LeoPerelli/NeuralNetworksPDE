...
losses = [ns.LossMeanSquares(name = 'fit', eval_roots = fit_loss, weight = 1), 
          ns.LossMeanSquares(name = 'bc',  eval_roots = bc_loss,  weight = 1),
          ns.LossMeanSquares(name = 'PDE', eval_roots = PDE,      weight = 1)
          ]
...
ns.minimize(pb, 'keras', tf.keras.optimizers.Adam(learning_rate = 0.01),   num_epochs = 500)
