...
data_int = data_int.loc[(data_int['mu'] == 1.00) & (data_int['theta'] == 0.0000)][['x','y','u']] # To begin, I try with a solution from the training set
data_bc  = data_bc.loc [(data_bc ['mu'] == 1.00) & (data_bc ['theta'] == 0.0000)][['x','y','u']] # 
